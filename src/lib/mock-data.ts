...
export const addMockUser = (
  user: Omit<User, "id" | "createdAt" | "balance">,
) => {
  const newUser: User = {
    ...user,
    id: (INITIAL_USERS.length + 1).toString(),
    createdAt: new Date().toISOString().split("T")[0],
    balance: 0,
  };
  INITIAL_USERS = [...INITIAL_USERS, newUser];
  return newUser;
};
...
export const MOCK_CRYPTO: CryptoHolding[] = [
  {
    ...
    name: "Bitcoin",
    quantity: 1.25,
    currentPriceUsd: 64200.5,
    change24hPercent: 2.4,
    purchasePriceUsd: 45000,
  },
  {
    symbol: "ETH",
    name: "Ethereum",
    quantity: 15.0,
    currentPriceUsd: 3450.2,
    change24hPercent: -1.2,
    purchasePriceUsd: 2800,
  },
  {
    symbol: "SOL",
    name: "Solana",
    quantity: 120.0,
    currentPriceUsd: 145.75,
...
export const MOCK_REAL_ESTATE: RealEstateHolding[] = [
  {
    address: "123 Luxury Ave, Miami, FL",
    estimatedValueUsd: 850000,
    changeRecentPercent: 1.5,
    purchasePriceUsd: 720000,
  },
  {
    address: "789 Tech Plaza, Austin, TX",
    estimatedValueUsd: 420000,
    changeRecentPercent: 4.2,
