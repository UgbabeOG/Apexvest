    ...
    <div className="min-h-screen flex flex-col bg-background">
      <div className="flex-grow grid lg:grid-cols-2">
        ...
        <div className="hidden lg:flex flex-col justify-between p-12 bg-primary text-primary-foreground relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-3 text-3xl font-bold tracking-tight cursor-pointer" onClick={() => router.push('/')}>
        ...
        <div className="flex flex-col justify-center items-center p-8 bg-background">
          <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-top-4 duration-700">
            <div className="text-center lg:hidden flex flex-col items-center mb-8" onClick={() => router.push('/')}>
            ...
            <div className="text-center text-sm text-muted-foreground pt-4">
              New investor? <span className="text-primary font-semibold cursor-pointer">Contact your administrator</span> for account creation.
            </div>
          </div>
        </div>
      </div>
