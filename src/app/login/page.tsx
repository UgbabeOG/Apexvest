...
import { TrendingUp, Lock, ArrowRight, ShieldCheck, Zap } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (user && password) {
        // Require any password for mockup purposes
        if (user.role === "admin") {
          router.push("/admin");
        } else {
        ...
        toast({
          ...
          description:
            "Invalid credentials. Please contact an admin if you believe this is an error.",
          variant: "destructive",
        });
        setIsLoading(false);
      }
    ...
    <div className="min-h-screen flex flex-col bg-background">
      <div className="flex-grow grid lg:grid-cols-2">
        ...
        <div className="hidden lg:flex flex-col justify-between p-12 bg-primary text-primary-foreground relative overflow-hidden">
          ...
          <div
            className="relative z-10 flex items-center gap-3 text-3xl font-bold tracking-tight cursor-pointer"
            onClick={() => router.push("/")}
          >
          ...
          <div className="relative z-10 max-w-lg space-y-6">
            <h1 className="text-5xl font-extrabold leading-tight">
              Mastering Wealth Across Frontiers
            </h1>
            <p className="text-lg text-white/70">
              A unified platform for managing high-growth cryptocurrency
              portfolios and premium real estate assets. Powered by AI for
              smarter decisions.
            </p>
            <div className="grid grid-cols-2 gap-6 pt-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-white/50">
                  Multi-layer protection for all assets.
                </p>
              </div>
              <div className="space-y-2">
        ...
        <div className="flex flex-col justify-center items-center p-8 bg-background">
          <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-top-4 duration-700">
            <div
              className="text-center lg:hidden flex flex-col items-center mb-8"
              onClick={() => router.push("/")}
            >
